...
All the above functions can be run with a wrapper, `run_Porous`, that takes care of running the simulation and calculating bulk density and C concentration:

```{r}
results<-run_Porous(ky=0.8, ko=0.035,
                     kmix=0.05,
                     e=0.143,
                     Im=1.1, Ir=0.5,
                     F_prot=0.1,
...
We can also specify a user-defined `f_text_mic`:
...
```{r fig3, dpi = 72, fig.height = 5, fig.width = 8}
par(mfrow=c(3,1))
